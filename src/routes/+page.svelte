...
<script>
  ...
  onMount(() => {
    checkRemoteReset();
    const interval = setInterval(checkRemoteReset, 5000);
...
<style>
  ...
  .card { background:var(--card-bg); border:1px solid rgba(var(--accent-rgb),.22); border-radius:24px; padding:32px 28px; box-shadow:0 8px 40px rgba(0,0,0,.08),inset 0 1px 0 rgba(255,255,255,.85); backdrop-filter:blur(10px); }
